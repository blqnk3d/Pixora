export class MenuBar {
  ...
  render() {
    ...
    var html = '<div class="menu-item">File<div class="menu-dropdown"><div class="menu-dropdown-item" data-action="new">New... <span class="shortcut">Ctrl+N</span></div><div class="menu-dropdown-item" data-action="open">Open... <span class="shortcut">Ctrl+O</span></div><div class="menu-dropdown-item" data-action="save">Save... <span class="shortcut">Ctrl+S</span></div><div class="menu-dropdown-item" data-action="export-gif">Export GIF</div></div></div><div class="menu-item">Edit<div class="menu-dropdown"><div class="menu-dropdown-item" data-action="undo">Undo <span class="shortcut">Ctrl+Z</span></div><div class="menu-dropdown-item" data-action="redo">Redo <span class="shortcut">Ctrl+Y</span></div><div class="menu-dropdown-item" data-action="clear">Clear Layer</div><div class="menu-dropdown-item" data-action="resize">Resize Canvas</div></div></div><div class="menu-item">View<div class="menu-dropdown"><div class="menu-dropdown-item" data-action="zoom-in">Zoom In <span class="shortcut">Ctrl+Scroll</span></div><div class="menu-dropdown-item" data-action="zoom-out">Zoom Out</div><div class="menu-dropdown-item" data-action="grid">Toggle Grid</div><div class="menu-dropdown-item" data-action="theme">Toggle Theme</div><div class="menu-dropdown-item" data-action="retro-font">Toggle Retro Font</div><div class="menu-dropdown-item" data-action="hide-bars">' + (hideBars ? '✓ ' : '') + 'Auto-hide Bars</div></div></div><div class="menu-item">Layer<div class="menu-dropdown"><div class="menu-dropdown-item" data-action="add-layer">Add Layer</div><div class="menu-dropdown-item" data-action="remove-layer">Remove Layer</div><div class="menu-dropdown-item" data-action="duplicate-layer">Duplicate Layer</div><div class="menu-dropdown-item" data-action="merge-down">Merge Down</div><div class="menu-dropdown-item" data-action="scale-50">Scale 50%</div><div class="menu-dropdown-item" data-action="scale-200">Scale 200%</div><div class="menu-dropdown-item" data-action="rotate-90">Rotate 90°</div><div class="menu-dropdown-item" data-action="rotate-180">Rotate 180°</div><div class="menu-dropdown-item" data-action="crop-selection">Crop to Selection</div></div></div><div class="menu-item">Image<div class="menu-dropdown"><div class="menu-dropdown-item" data-action="remove-bg">Remove Background</div></div></div>';
